...
| [`prd/07-prd-odonto-saas.md`](prd/07-prd-odonto-saas.md) | Vertical odontologia em modo SaaS — escopo comercial, integração Clinicorp, gaps de SaaS |
| [`odonto/README.md`](odonto/README.md) | **Vertical odontologia** — ambiente, mapa de configuração, dimensionamento WAHA, runbooks de piloto e operação SaaS |
